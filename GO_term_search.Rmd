...
load data created in diff_expr_analysis.Rmd
```{r}
sample_name <- "Neuropil_vs_Somata"
...
Take gene names that are up and down regulated
```{r}
...
Output all results as PDF
```{r}
pdf(paste(sample_name, "Biological_Proccess_Upregulated.pdf", sep = "_"))
plot_up_BP
dev.off()

pdf(paste(sample_name, "Molecular_Function_Upregulated.pdf", sep = "_"))
plot_up_MF
dev.off()

pdf(paste(sample_name, "Cellular_Component_Upregulated.pdf", sep = "_"))
plot_up_CC
dev.off()

pdf(paste(sample_name, "Biological_Proccess_Downregulated.pdf", sep = "_"))
plot_down_BP
dev.off()

pdf(paste(sample_name, "Molecular_Function_Downregulated.pdf", sep = "_"))
plot_down_MF
dev.off()

pdf(paste(sample_name, "Cellular_Component_Downregulated.pdf", sep = "_"))
plot_down_CC
dev.off()
```
